...
#define _nstates5	71	/* rool4 */
#define minseq5	139
#define maxseq5	208
#define _endstate5	70
...
#define _nstates0	78	/* queueAction */
#define minseq0	0
#define maxseq0	76
#define _endstate0	77
...
#define Air0	(sizeof(P0) - Offsetof(P0, _3_1_timer) - 1*sizeof(int))
