...
#define _nstates5	18	/* rool4 */
#define minseq5	120
#define maxseq5	136
#define _endstate5	17

#define _nstates4	14	/* rool3 */
#define minseq4	107
#define maxseq4	119
#define _endstate4	13

#define _nstates3	14	/* rool2 */
#define minseq3	94
#define maxseq3	106
#define _endstate3	13

#define _nstates2	14	/* rool1 */
#define minseq2	81
#define maxseq2	93
#define _endstate2	13

#define _nstates1	24	/* :init: */
#define minseq1	58
#define maxseq1	80
#define _endstate1	23

#define _nstates0	59	/* queueAction */
#define minseq0	0
#define maxseq0	57
...
#define PqueueAction	((P0 *)this)
typedef struct P0 { /* queueAction */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
	...
	int _3_1_lottery;
	int _3_1_timer;
	int _3_1_waitingTime;
} P0;
#define Air0	(sizeof(P0) - Offsetof(P0, _3_1_waitingTime) - 1*sizeof(int))
